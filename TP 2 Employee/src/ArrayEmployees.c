...
int askEmployee (Employee list[], int len)
{
	...
	getInt(&sector, "Enter the sector:\n"
				...
				getString(lastName, "Enter the name: ", "ERROR, only 50 characters and letters only, Enter the last name: ", 51);
...
int sortEmployees(Employee list[], int len, int order)
{
	...
	printf("Enter the order (1.asc 2.desc): \n");
	scanf("%d", &order);

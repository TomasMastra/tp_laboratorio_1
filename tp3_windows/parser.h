 ...
 * @brief guarda los jugadores desde el archivo jugadores.txt
 *
 * @param char* path: recive la ruta del archivo
 * @param LinkedList* pArrayListJugador: recive la lista de jugadores
 * @return 1
 */
 ...
 * @brief guarda los jugadores desde el archivo jugadoresConvocados.bin
 *
 * @param char* path: recive la ruta del archivo
 * @param LinkedList* pArrayListJugador: recive la lista de jugadores
 * @return 1
